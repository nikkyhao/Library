												...
												<div class="widget-body">
													<div class="widget-main">
													  <div>
                                                        ...
                                                        <input type="text" class="form-control" id="form-field-1" placeholder="Default Text" value="">
														</div>

														<hr />

													  <div>
														<label for="form-field-9">学号</label>
                                                          <input type="text" class="form-control limited" id="form-field-2" value="" maxlength="50">
														</div>

														<hr />

													  <div>
														<label for="form-field-11">身份证号</label>
                                                          <input type="text" class="autosize-transition form-control" id="form-field-3" value="">
														</div>
                                                        
                                                        <hr />
                                                      <div>
														<label for="form-field-9">性别</label>
                                                          <input type="text" class="form-control limited" id="form-field-4" value="" maxlength="50">
														</div>

														<hr />
                                                      <div>
														<label for="form-field-9">联系电话</label>
                                                          <input type="text" class="form-control limited" id="form-field-5" value="" maxlength="50">
														</div>
                                                        <hr />
                                                      <div>
														<label for="form-field-9">原密码</label>
                                                          <input type="password" class="form-control limited" id="form-field-6" value="" maxlength="50">
														</div>
<hr />
                                                      <div>
														<label for="form-field-9">新密码</label>
                                                          <input type="password" class="form-control limited" id="form-field-7" value="" maxlength="50">
														</div>
													</div>
												</div>
								<button class="btn btn-info" type="button">
									...
									<div class="col-xs-12 col-sm-4">
											<div class="widget-box">
											  <div class="widget-header">
											  <h4 class="widget-title">借阅证信息</h4></div>
