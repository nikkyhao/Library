															...
															<div class="profile-activity clearfix">
																...
																<div>
																	...
																	<a class="user" href="#"><%=rs.getString("bookname")%> </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
																	 <i class="ace-icon fa fa-clock-o bigger-110"></i><%=rs.getString("score")%>分
																	<div class="time">
																	<i class="ace-icon fa fa-clock-o bigger-110"></i><%=rs.getString("remark")%></div>
															  </div>
